...
class JFormFieldSpacerinfo extends JFormField 
{
	...
	public function getInput()
	{
		...
		<p>&nbsp;</p>
		<p style="background-color:#CA1F17; color:#FFF; padding:5px 10px; border-radius:5px;"><strong>Caution: Put this plugin at the end of the plugin order in the Plug-in Manager.</strong></p>
